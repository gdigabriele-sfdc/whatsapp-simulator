...
(function (global) {
  ...
  function s(name, status, clock, messages) {
    return {
      contact: { name, status, avatarDataUrl: null },
      clock: clock || '',
      messages: messages
    };
  }
  ...
  const LIST = [
...

    {
      ...
      scenario: s('Intesa Sanpaolo · Laura', 'online', '10:23', [
        { sender: 'them', text: 'Buongiorno Sig. Rossi! Sono Laura della filiale, come posso aiutarla?' },
        { sender: 'me',   text: 'Salve, vorrei informazioni sul nuovo conto Zero Spese' },
        { sender: 'them', text: 'Certamente. Il conto ha canone 0€ e include una carta di debito gratuita 💳' },
...

    {
      ...
      scenario: s('Dott.ssa Bianchi · Studio', 'online', '15:45', [
        { sender: 'me',   text: 'Buongiorno Dottoressa, le scrivo per fissare un controllo' },
        { sender: 'them', text: 'Salve! Quando preferisce? Ho disponibilità lunedì alle 17 o mercoledì alle 9' },
...

    {
      ...
      scenario: s('Zalando · Assistenza', 'online', '11:10', [
        { sender: 'me',   text: 'Buongiorno, ho un problema con l\'ordine #IT45872931' },
        { sender: 'them', text: 'Buongiorno! Mi dispiace, mi racconti pure cosa è successo' },
        { sender: 'me',   text: 'Le scarpe arrivate sono della taglia sbagliata: ho ordinato il 42 ed è arrivato il 40' },
...

    {
      id: 'manufacturing',
      label: 'Manufacturing',
      scenario: s('Tecnomec · Ufficio Vendite', 'online', '09:30', [
        { sender: 'them', text: 'Buongiorno Ing. Conti, le invio il preventivo richiesto per i cuscinetti serie K' },
...

    {
      ...
      scenario: s('TIM · Customer Care', 'online', '16:50', [
        { sender: 'me',   text: 'Buongiorno, vorrei capire perché la mia bolletta è raddoppiata questo mese' },
...

    {
      ...
      scenario: s('Giulia · Customer Success', 'online', '14:15', [
        { sender: 'them', text: 'Ciao Marco! Tutto ok con la nuova integrazione API? 🙌' },
        ...
        { sender: 'them', text: 'No, è un bug noto che abbiamo fixato nella v3.2 dell\'SDK' },
...

    {
      id: 'automotive',
      label: 'Automotive',
      scenario: s('Audi Milano · Marco', 'online', '17:20', [
        { sender: 'me',   text: 'Buongiorno, vorrei prenotare un test drive del nuovo Q4 e-tron' },
...

    {
      ...
      scenario: s('Enel Energia', 'online', '12:00', [
        { sender: 'me',   text: 'Buongiorno, vorrei passare alla tariffa monoraria fissa' },
...

    {
      ...
      scenario: s('Hotel Belvedere · Como', 'online', '18:30', [
        { sender: 'me',   text: 'Buonasera, volevo confermare la prenotazione per il weekend' },
        ...
        { sender: 'them', text: 'Certo, le passo direttamente la SPA: 0341 234567' },
...

    {
      id: 'education',
      label: 'Education',
      scenario: s('Università Bocconi · Segreteria', 'online', '10:00', [
        { sender: 'me',   text: 'Buongiorno, vorrei iscrivermi al test di ammissione per la magistrale' },
        { sender: 'them', text: 'Buongiorno! Le iscrizioni sono aperte fino al 15 luglio sul portale studenti' },
        { sender: 'me',   text: 'Quanto costa la tassa di iscrizione al test?' },
        { sender: 'them', text: '€100 da pagare via PagoPA dopo aver compilato il modulo online' },
...

    {
      ...
      scenario: s('Save the Children · Sara', 'online', '13:30', [
        { sender: 'them', text: 'Ciao Anna! Grazie per il tuo interesse a diventare volontaria 💛' },
...

    {
      ...
      scenario: s('Comune di Roma · URP', 'online', '08:45', [
        { sender: 'me',   text: 'Buongiorno, devo richiedere un certificato di residenza' },
        { sender: 'them', text: 'Buongiorno! Lo può scaricare gratuitamente da anagrafenazionale.gov.it con SPID' },
...

    {
      id: 'real_estate',
      label: 'Real Estate',
      scenario: s('Tecnocasa · Agenzia Centro', 'online', '16:00', [
        { sender: 'them', text: 'Buongiorno! Le scrivo per l\'appartamento di Via Verdi 18 che ha visto online' },
